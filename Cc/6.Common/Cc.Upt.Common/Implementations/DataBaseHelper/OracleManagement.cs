...
using Cc.Upt.Common.Definitions;
using Cc.Upt.Common.LogHelper;
using Oracle.ManagedDataAccess.Client;

namespace Cc.Upt.Common.Implementations.DataBaseHelper
{
    public class OracleManagement : IDataBaseStrategy
    {
        public bool ExecuteQuery(string query, IDictionary<string, object> queryParameters, string connectionString,
            out Exception exception)
        {
            exception = null;
            var excecutedCorrectrly = false;
