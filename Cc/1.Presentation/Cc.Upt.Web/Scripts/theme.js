...
(function($) {
    ...
    function expand(li) {
        li.children("ul.nav-children").slideDown("fast",
            function() {
    ...
    function collapse(li) {
        li.children("ul.nav-children").slideUp("fast",
            function() {
                $(this).css("display", "");
...
(function(theme, $) {
    ...
    var Skeleton = {
        ...
        fixScroll: function() {
            ...
            $window
                .on("sidebar-left-opened sidebar-right-toggle",
                    function(e, data) {
        ...
        eventsSidebarRight: function() {
            ...
            var open = function() {
                ...
                $html.on("click.close-right-sidebar",
                    function(e) {
                        e.stopPropagation();
                        close(e);
                    });
            ...
            var close = function(e) {
                if (!!e &&
                    !!e.target &&
                    ($(e.target).closest(".sidebar-right").get(0) || !$(e.target).closest("html").get(0))) {
                    e.preventDefault();
                    return false;
                }
            ...
            var bind = function() {
                $('[data-open="sidebar-right"]').on("click",
                    function(e) {
                        var $el = $(this);
                        e.stopPropagation();
        ...
        eventsContentMenu: function() {
            ...
            var open = function() {
                ...
                $html.on("click.close-inner-menu",
                    function(e) {
            ...
            var close = function(e) {
                if (!!e &&
                    ...
                    ($(e.target).closest(".inner-menu").get(0) || !$(e.target).closest("html").get(0))) {
                    return false;
                }
...
(function(theme, $) {
    ...
    Mailbox.prototype = {
        ...
        eventsCompose: function() {
            ...
            var timer;
            $(window)
                .on("resize orientationchange sidebar-left-toggle mailbox-recalc",
                    function() {
                        clearTimeout(timer);
...
(function($) {
    ...
    var LockScreen = {
        ...
        events: function() {
            ...
            this.$body.find('[data-lock-screen="true"]').on("click",
                function(e) {
                    e.preventDefault();
        ...
        $(".panel")
            ...
            .on("click",
                ...
                function(e) {
                    ...
                    if (!!($panel.parent("div").attr("class") || "").match(/col-(xs|sm|md|lg)/g) &&
    ...
    GMapBuilder.prototype = {
        ...
        build: function() {
            ...
            if (!!window.SnazzyThemes) {
                ...
                $.each(window.SnazzyThemes,
                    function(i, theme) {
                        themeOpts.push($('<option value="' + theme.id + '">' + theme.name + "</option>")
            ...
            google.maps.event.addDomListener(window,
                "load",
                function() {
                    _self.options.mapOptions.center = new google.maps.LatLng(_self.options.mapOptions.center.lat,
        ...
        events: function() {
            ...
            this.marker.$removeAll.on("click",
                function(e) {
                    e.preventDefault();
            ...
            // preview events
            this.$previewModal.on("shown.bs.modal",
                function() {
                    _self.preview();
                });
            ...
            // get code events
            this.$getCodeModal.on("shown.bs.modal",
                function() {
                    _self.getCode();
                });
        ...
        mapEvents: function() {
            ...
            google.maps.event.addDomListener(_self.map,
                "resize",
                function() {
        ...
        updateMapProperty: {
            ...
            maptype: function(value) {
                ...
                mapStyles = this.$wrapper.find('[data-builder-field="maptheme"]').children("option").filter(":selected")
                    .data("json");
            ...
            maptheme: function(value) {
                ...
                options = {};
                json = this.$wrapper.find('[data-builder-field="maptheme"]').children("option").filter(":selected")
                    .data("json");
        ...
        _geocode: function(marker) {
            ...
            this.geocoder.geocode({ address: marker.location },
        ...
        _bindMarkerClick: function(marker) {
            ...
            google.maps.event.addListener(marker._instance,
                "click",
                function() {
        ...
        getCode: function() {
            this.$getCodeModal.find(".modal-body pre")
        ...
        generate: function() {
            ...
            var zoomControl = this.$wrapper.find('[data-builder-field="zoomcontrol"] option:selected').val() !==
                "false";
            var mapTypeControl = this.$wrapper.find('[data-builder-field="maptypecontrol"] option:selected').val() !==
                "false";
            var overviewMapControl = this.$wrapper.find('[data-builder-field="overviewcontrol"] option:selected').val()
                .toLowerCase();
            var $themeControl = this.$wrapper.find('[data-builder-field="maptheme"] option:selected')
                .filter(":selected");
            ...
            output = output
                ...
                .replace(/\{disableDoubleClickZoom\}/,
                    this.$wrapper.find('[data-builder-field="clicktozoomcontrol"] option:selected').val() === "false")
                .replace(/\{mapTypeControl\}/, mapTypeControl)
                .replace(/\{scaleControl\}/,
                    this.$wrapper.find('[data-builder-field="scalecontrol"] option:selected').val() !== "false")
                .replace(/\{scrollwheel\}/,
                    this.$wrapper.find('[data-builder-field="scrollwheelcontrol"] option:selected').val() !== "false")
                .replace(/\{panControl\}/,
                    this.$wrapper.find('[data-builder-field="pancontrol"] option:selected').val() !== "false")
                .replace(/\{streetViewControl\}/,
                    this.$wrapper.find('[data-builder-field="streetviewcontrol"] option:selected').val() !== "false")
                .replace(/\{draggable\}/,
                    this.$wrapper.find('[data-builder-field="draggablecontrol"] option:selected').val() !== "false")
                .replace(/\{overviewMapControl\}/, overviewMapControl !== "false")
                .replace(/\{mapTypeId\}/,
                    this.$wrapper.find('[data-builder-field="maptype"] option:selected').val().toUpperCase());

            if (zoomControl) {
                work = {
                    zoomControlOptions: {
                        style: this.$wrapper.find('[data-builder-field="maptypecontrol"] option:selected').val()
                            .toUpperCase()
                    }
                };
                output = output.replace(/\{zoomControlOptions\}/,
                    "zoomControlOptions: {\r\n                style: google.maps.ZoomControlStyle." +
                    this.$wrapper.find('[data-builder-field="zoomcontrol"] option:selected').val().toUpperCase() +
                    "\r\n\            },");
            } else {
                output = output.replace(/\{zoomControlOptions\}/, "");
            }
            ...
            if (mapTypeControl) {
                ...
                output = output.replace(/\{mapTypeControlOptions\}/,
                    ...
                    this.$wrapper.find('[data-builder-field="maptypecontrol"] option:selected').val().toUpperCase() +
                    "\r\n\            },");
            } else {
                output = output.replace(/\{mapTypeControlOptions\}/, "");
            }
...
(function(theme, $) {
    ...
    PluginPortlet.prototype = {
        ...
        events: function($el) {
            ...
            $el.find(".panel-actions").on("click",
...
(function(theme, $) {
    ...
    WidgetTodoList.prototype = {
        ...
        events: function() {
            ...
            $remove.on("click.widget-todo-list",
                function(ev) {
                    ev.preventDefault();
...
(function(theme, $) {
    ...
    WidgetToggleExpand.prototype = {
        ...
        events: function() {
            ...
            $toggler.on("click.widget-toggler",
                function() {
        ...
        expand: function(content) {
            content.children(".widget-content-expanded").slideDown("fast",
                function() {
                    $(this).css("display", "");
        ...
        collapse: function(content) {
            content.children(".widget-content-expanded").slideUp("fast",
                function() {
        ...
        $.extend(true,
            $.fn.dataTable.defaults,
            {
                ...
                fnInitComplete: function(settings, json) {
                    ...
                    $search
                        .attr({
                            placeholder: typeof options.searchPlaceholder !== "undefined"
